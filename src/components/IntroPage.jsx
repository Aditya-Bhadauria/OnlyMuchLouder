  ...
  return (
    ...
    <div className="relative flex items-center justify-between h-screen bg-white text-gray-900 p-4 md:p-8 lg:p-16">
      ...
      <div className="flex-1 flex flex-col items-start lg:items-center justify-center z-20 space-y-4 md:space-y-6 lg:space-y-8 p-4 lg:p-8">
        ...
        {/* Main Title with Leckerli font */}
        <div
          className="text-[10vw] md:text-[8vw] lg:text-[6vw] font-bold tracking-tight text-right leading-[1.1]"
          style={{
            fontFamily: "'Leckerli One', cursive", // Applying 'Leckerli One' font here for the main title
            color: '#000',
            fontWeight: '900',
            letterSpacing: '-0.05em',
          }}
          ...
          <span>
            <TextGenerateEffect
              ...
              style={{
                ...
                fontWeight: '900',
                letterSpacing: '-0.05em',
                fontFamily: "'Leckerli One', cursive", // Applying 'Leckerli One' font here as well
              }}
            />
          </span>
        </div>

        {/* Sub-Title with Leckerli font */}
        <motion.div
          className="text-[5vw] md:text-[4vw] lg:text-[3vw] font-medium tracking-wide leading-tight text-right"
          style={{
            y: taglineY,
            opacity: 0.8,
            fontFamily: "'Leckerli One', cursive", // Applying 'Leckerli One' font to subtitle
          }}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.4, duration: 1.2, ease: 'easeOut' }}
        >
          <span>We fuel Pop Culture</span>
        </motion.div>
